...
///
/// ```ignore
/// use dirigent_core::auto_save::AutoSaveManager;
/// use dirigent_core::persistence_service::{AutoSaveConfig, DefaultPersistenceService, PersistenceService};
/// use std::sync::Arc;
/// use std::path::Path;
///
...
impl AutoSaveManager {
    ...
    /// ```
    /// use dirigent_core::auto_save::AutoSaveManager;
    /// use dirigent_core::persistence_service::{AutoSaveConfig, DefaultPersistenceService};
    /// use std::sync::Arc;
    /// use std::path::Path;
    ///
    ...
    fn should_save_on_event(event: &DirigentEvent) -> bool {
        matches!(
            event,
            DirigentEvent::SessionStatusChanged { .. }
                | DirigentEvent::SessionCreated { .. }
                | DirigentEvent::SessionClosed { .. }
        )
    }

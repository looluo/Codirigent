...
///
/// ```
/// use dirigent_core::DEFAULT_PROMPT_TEMPLATE;
///
...
///
/// ```
/// use dirigent_core::AssignmentConfig;
///
/// let config = AssignmentConfig::default();
...
///
/// ```
/// use dirigent_core::{PendingAssignment, TaskId, SessionId};
///
...
///
/// ```
/// use dirigent_core::{AssignmentAction, TaskId, SessionId};
///
...
impl AssignmentManager {
    ...
    ///
    /// ```
    /// use dirigent_core::{AssignmentManager, AssignmentConfig, DefaultEventBus};
    /// use std::sync::Arc;
    ///
    /// let event_bus = Arc::new(DefaultEventBus::new(16));

...
//!
//! ```
//! use dirigent_core::skill::{Skill, SkillType, TokenBudget, SkillPreset};
...
///
/// ```
/// use dirigent_core::skill::{Skill, SkillType};
/// use std::path::PathBuf;
///
/// let skill = Skill::new_user(
///     "commit".to_string(),
...
///
/// ```
/// use dirigent_core::skill::TokenBudget;
///
/// let mut budget = TokenBudget::default_claude();
...
///
/// ```
/// use dirigent_core::skill::SkillPreset;
///

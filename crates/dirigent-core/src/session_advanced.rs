...
//!
//! ```
//! use dirigent_core::session_advanced::{
...
///
/// ```
/// use dirigent_core::session_advanced::ContextHandoff;
/// use dirigent_core::SessionId;
/// use std::path::PathBuf;
///
...
///
/// ```
/// use dirigent_core::session_advanced::SessionTemplate;
/// use std::path::PathBuf;
///
...
///
/// ```
/// use dirigent_core::session_advanced::SessionGroup;
/// use dirigent_core::SessionId;
///
...
///
/// ```
/// use dirigent_core::session_advanced::OvernightConfig;
///
...
///
/// ```
/// use dirigent_core::session_advanced::OvernightSummary;
///

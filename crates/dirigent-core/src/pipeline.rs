...
//!
//! ```
//! use dirigent_core::pipeline::{PipelineStage, ReviewDecision, PipelineState};
...
///
/// ```
/// use dirigent_core::pipeline::PipelineStage;
///
...
///
/// ```
/// use dirigent_core::pipeline::ReviewDecision;
///
...
///
/// ```
/// use dirigent_core::pipeline::{PipelineState, PipelineStage};
/// use dirigent_core::{SessionId, TaskId};
/// use std::path::PathBuf;
///
...
impl PipelineState {
    ...
    ///
    /// ```
    /// use dirigent_core::pipeline::PipelineState;
    /// use dirigent_core::{SessionId, TaskId};
    /// use std::path::PathBuf;
    ///
    /// let state = PipelineState::new(
...
///
/// ```
/// use dirigent_core::pipeline::{PipelineEvent, PipelineStage};
/// use dirigent_core::{SessionId, TaskId};
///
...
///
/// ```
/// use dirigent_core::pipeline::FailureMessageFormatter;

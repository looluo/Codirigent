//! Configuration types for the Dirigent application.
//!
...
//!
//! - Project config: `.dirigent/config.json`
...
/// Project-level configuration stored in `.dirigent/config.json`.
///
/// This configuration is specific to a project and controls how Dirigent
/// behaves when working in that project directory.
///
/// # Example
///
/// ```
/// use dirigent_core::config::ProjectConfig;
///
...
///
/// ```
/// use dirigent_core::config::VerificationSettings;
///
...
///
/// ```
/// use dirigent_core::config::{SessionNotesConfig, SummaryMode};
///
...
///
/// ```
/// use dirigent_core::config::SessionsConfig;
///
...
///
/// ```
/// use dirigent_core::config::GitConfig;
///
...
///
/// ```
/// use dirigent_core::config::UserSettings;
///
...
///
/// ```
/// use dirigent_core::config::AppearanceSettings;
///
...
///
/// ```
/// use dirigent_core::config::NotificationSettings;
///
...
/// Module-specific settings.
///
/// Contains settings for individual Dirigent modules.
...
///
/// ```
/// use dirigent_core::config::InputDetectorSettings;
///
...
///
/// ```
/// use dirigent_core::config::ContextTrackerSettings;
///

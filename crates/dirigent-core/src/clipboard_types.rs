...
//!
//! ```
//! use dirigent_core::clipboard_types::CliType;
//! use std::path::Path;
//!
...
//!
//! ```
//! use dirigent_core::clipboard_types::{ClipboardContent, ImageData, ImageFormat};
//! use dirigent_core::ClipboardContentType;
...
///
/// ```
/// use dirigent_core::clipboard_types::ImageFormat;
///
...
///
/// ```
/// use dirigent_core::clipboard_types::{ImageData, ImageFormat};
///
/// let data = ImageData {
///     bytes: vec![0x89, 0x50, 0x4E, 0x47], // PNG magic bytes
///     width: 1920,
...
///
/// ```
/// use dirigent_core::clipboard_types::ClipboardContent;
/// use dirigent_core::ClipboardContentType;
/// use std::path::PathBuf;
///
/// // Text content

...
//!
//! This module defines the core abstractions for the Dirigent plugin system:
//!
...
///
/// ```
/// use dirigent_core::plugin::PluginMetadata;
///
...
///
/// ```
/// use dirigent_core::plugin::PluginCapabilities;
///
...
///
/// This trait defines the contract for plugins in the Dirigent system.
...
///
/// ```ignore
/// use dirigent_core::plugin::{Plugin, PluginMetadata, PluginCapabilities, PluginState};
...
///         Ok(())
///     }
///     fn handle_event(&mut self, _: &DirigentEvent) {}
...
pub trait Plugin: Send + Sync + std::fmt::Debug {
    ...
    fn handle_event(&mut self, event: &DirigentEvent);
...
mod tests {
    ...
    impl Plugin for MockPlugin {
        ...
        fn handle_event(&mut self, _event: &DirigentEvent) {
            self.event_count += 1;
        }
    ...
    fn test_mock_plugin_handle_event() {
        ...
        plugin.handle_event(&DirigentEvent::SessionCreated { id: SessionId(1) });
        assert_eq!(plugin.event_count, 1);

        plugin.handle_event(&DirigentEvent::SessionClosed { id: SessionId(1) });

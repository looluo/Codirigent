...
//!
//! ```
//! use dirigent_core::session_notes::{
...
///
/// ```
/// use dirigent_core::session_notes::{SessionNotesConfig, SummaryMode};
...
///     output_dir: Some(PathBuf::from(".dirigent/notes")),
/// };
...
impl Default for SessionNotesConfig {
    fn default() -> Self {
        Self {
            ...
            output_dir: None, // Uses .dirigent/sessions/ by default
        }
    }
}
...
///
/// ```
/// use dirigent_core::session_notes::SummaryMode;
///
...
///
/// ```
/// use dirigent_core::session_notes::CompletionStatus;
///
...
///
/// ```
/// use dirigent_core::session_notes::{SessionNote, CompletionStatus};
/// use dirigent_core::{SessionId, TaskId};
///
...
///
/// ```
/// use dirigent_core::session_notes::{Learning, LearningCategory};
///
/// let learning = Learning {
///     category: LearningCategory::Preference,
///     content: "Use jose instead of jsonwebtoken for ESM compatibility".to_string(),
...
///
/// ```
/// use dirigent_core::session_notes::LearningCategory;
///
...
/// };
/// use dirigent_core::{SessionId, TaskId, ChangeSummary};
/// use dirigent_core::verification::VerificationStatus;
/// use std::path::Path;
///
...
///
/// ```
/// use dirigent_core::session_notes::{LearningsExtractor, Learning};
///
/// // Trait is typically implemented by dirigent-verification crate
...
mod tests {
    ...
    fn test_session_notes_config_custom() {
        ...
        assert!(!config.structured_data_only);
        assert_eq!(config.output_dir, Some(PathBuf::from(".dirigent/notes")));
    }

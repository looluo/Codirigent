...
///
/// ```
/// use dirigent_core::persistence::PersistentSession;
...
impl PersistentState {
    ...
    ///
    /// ```
    /// use dirigent_core::persistence::{PersistentSession, PersistentState};
    /// use dirigent_core::{Session, SessionId};
    /// use std::path::PathBuf;
    ///
...
///
/// ```
/// use dirigent_core::persistence::{Checkpoint, PersistentState};
///
/// let state = PersistentState::new();
...
///
/// ```
/// use dirigent_core::persistence::RecoveryResult;

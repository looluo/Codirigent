...
use gpui::{
    actions, div, px, size, App, AppContext, Application, Bounds, Context, Entity, FocusHandle,
...
// Application actions (warnings from macro-generated structs are expected)
actions!(
    codirigent,
    [
        NewSession,

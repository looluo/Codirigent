...
//! - Child modules under `workspace/gpui/` are created now so later phases can
//!   move helper clusters without changing public module paths.
//!
//! # Example
//!
//! ```ignore
...
// Phase A keeps the implementation in this root file. The child modules above
// are intentionally empty scaffolding until Phase C moves helper clusters.

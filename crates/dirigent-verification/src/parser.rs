...
//!
//! ```
//! use dirigent_verification::{CargoTestParser, OutputParser};
//! use dirigent_core::verification::VerificationCheckType;
//!
...
use dirigent_core::verification::{VerificationCheckType, VerificationFailure, VerificationResult};
use regex::Regex;
...
pub fn parser_for_project(project_type: Option<dirigent_core::ProjectType>) -> Box<dyn OutputParser> {
    use dirigent_core::ProjectType;

...
//!
//! ```no_run
//! use dirigent_verification::VerificationGate;
//! use dirigent_core::{TaskId, Verifier};
//! use std::path::Path;
//!
...
use dirigent_core::{ProjectType, SessionId, TaskId, VerificationDetector, Verifier};
...
impl VerificationGate {
    ...
    /// ```
    /// use dirigent_verification::VerificationGate;
    /// use dirigent_core::verification::VerificationConfig;
    ///

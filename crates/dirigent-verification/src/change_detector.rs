...
//!
//! ```no_run
//! use dirigent_verification::GitChangeDetector;
//! use dirigent_core::{ChangeDetector, SessionId, TaskId};
//! use std::path::Path;
//!
...
impl GitChangeDetector {
    ...
    /// ```
    /// use dirigent_verification::GitChangeDetector;
    /// use dirigent_core::{RiskAssessor, ChangeType, RiskLevel};
    /// use std::path::Path;
    ///
    /// let detector = GitChangeDetector::new();
...
mod tests {
    ...
    fn test_new_detector() {
        ...
        assert_eq!(risk, dirigent_core::RiskLevel::Medium);
    }
    ...
    fn test_with_assessor() {
        ...
        assert_eq!(risk, dirigent_core::RiskLevel::High);
    }
...
"#;
    ...
    fn test_parse_porcelain_status_with_risk_assessment() {
        ...
        assert_eq!(changes[0].risk_level, dirigent_core::RiskLevel::High);
    }

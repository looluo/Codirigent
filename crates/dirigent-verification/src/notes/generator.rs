...
///
/// ```
/// use dirigent_verification::notes::DefaultNotesGenerator;
/// use dirigent_core::{NotesGenerator, CompletionStatus, SessionId, TaskId};
///
...
mod tests {
    use super::*;
    use dirigent_core::change_summary::{FileCategory, FileChange, RiskAssessment};
    use dirigent_core::verification::{VerificationResult, VerificationState};
    ...
    fn test_render_markdown_basic() {
        ...
        assert!(markdown.contains("Generated by Dirigent"));
    }
    ...
    fn test_render_markdown_with_learnings() {
        ...
        let note = SessionNote {
            ...
            learnings: vec![
                Learning::new(
                    dirigent_core::session_notes::LearningCategory::Preference,
                    "Use jose instead of jsonwebtoken",
                    true,
                ),
                Learning::new(
                    dirigent_core::session_notes::LearningCategory::Gotcha,

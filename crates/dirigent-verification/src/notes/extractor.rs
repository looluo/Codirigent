...
use dirigent_core::session_notes::{Learning, LearningCategory, LearningsExtractor};
use regex::Regex;
use tracing::debug;
...
///
/// ```
/// use dirigent_verification::notes::PatternLearningsExtractor;
/// use dirigent_core::{LearningsExtractor, LearningCategory};
///

//! Advanced theme configuration system for Dirigent.
//!
...
//!
//! ```
//! use dirigent_ui::theme_config::Theme;
//!
...
///
/// A theme contains all visual settings for the Dirigent UI, including
...
impl Theme {
    ...
    ///
    /// Uses colors from the Dirigent spec with a dark background.
    ///
    /// # Example
    ///
    /// ```

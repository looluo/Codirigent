//! Layout profile management for Dirigent.
//!
...
//!
//! ```
//! use dirigent_ui::layout_profile::{LayoutProfileManager, SavedLayoutProfile};
//! use dirigent_core::LayoutMode;
//!
...
use dirigent_core::{GridPosition, LayoutMode, SessionId};
...
impl LayoutProfileManager {
    ...
    ///
    /// ```
    /// use dirigent_ui::layout_profile::LayoutProfileManager;
    ///

...
//! to the Dirigent theme color format.

use crate::theme::{DirigentTheme, Rgba};
...
pub fn convert_color(color: TermColor, theme: &DirigentTheme, _is_foreground: bool) -> Rgba {
    match color {
...
pub fn named_color_to_rgba(color: NamedColor, theme: &DirigentTheme) -> Rgba {
    match color {
